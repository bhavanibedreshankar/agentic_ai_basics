...
python3 03_Tools_and_Actions/browser_computer_use/browser_computer_use.py
```
...
- `../../01_Core_Architecture/tool_use/README.md` — the client-side tool-calling loop this template's `read_page`/`click`/`type_text` tools follow
