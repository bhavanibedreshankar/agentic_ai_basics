...
`../../01_Core_Architecture/tool_use/` or `../../08_Agent_Frameworks_and_Patterns/tool_registry/` because the schema and command
...
in `../../01_Core_Architecture/tool_use/README.md`'s underlying tool-use concepts for the
