...
- **Real search, not a local knowledge base** — contrast with every other "search" tool in this repo (`../../06_Task_and_State_Management/context_management/retrieval.py`, `../../09_RAG_and_Knowledge/embedding/`, `../../05_Memory/external_memory/`): those all search a small, fixed set of documents you defined ahead of time. This tool searches the actual current internet — no knowledge base to write, no embedding function to implement.
...
python3 03_Tools_and_Actions/web_search/web_search.py
```
...
- `../../09_RAG_and_Knowledge/README.md` — building your own search over a knowledge base you control, for when live web results aren't what you want
