...
Every custom tool up to this point (`../../01_Core_Architecture/tool_use/`, `../../08_Agent_Frameworks_and_Patterns/tool_registry/`,
`../../05_Memory/external_memory/`, etc.) is CLIENT-SIDE: Claude sends a
