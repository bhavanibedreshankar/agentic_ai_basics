...
../tool_use/basic_agentic_tools.py hand-maintains tool metadata in TWO separate places:
...
def register_tool(name: str, description: str, input_schema: dict):
    ...
    function like in ../tool_use/basic_agentic_tools.py.
    """
...
# ---------------------------------------------------------------------------
# The agentic loop — identical shape to ../tool_use/basic_agentic_tools.py, but tool
