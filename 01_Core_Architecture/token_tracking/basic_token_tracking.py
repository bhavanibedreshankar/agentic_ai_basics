...
../../02_Execution_Loops/agentic_loop/basic_agentic_loop.py with per-turn and cumulative token tracking, plus a
...
Concepts demonstrated:
  ...
  3. CUMULATIVE TRACKING — accumulating usage across every turn of a
     ...
     history (see ../../02_Execution_Loops/agentic_loop/basic_agentic_loop.py), so cost compounds as a
...
class SessionUsage:
    ...
    Note: this template doesn't trim history (unlike ../../05_Memory/memory_management/basic_agentic_memory.py's
