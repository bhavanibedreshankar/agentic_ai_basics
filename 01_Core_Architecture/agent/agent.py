...
# agent may run, same idea as ../../02_Execution_Loops/max_iterations/max_iterations.py.
...
def _safe_eval(node: ast.AST):
    ...
    # ../../08_Agent_Frameworks_and_Patterns/tool_registry/basic_tool_registry.py's calculate tool.
