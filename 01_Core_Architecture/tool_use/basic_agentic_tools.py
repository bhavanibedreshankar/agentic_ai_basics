...
A tool-using agent has TWO loops working together:
  1. The OUTER loop (in main()) — same pattern as ../../02_Execution_Loops/agentic_loop/basic_agentic_loop.py: keep
...
def main() -> None:
    ...
    # ---- OUTER LOOP: same shape as ../../02_Execution_Loops/agentic_loop/basic_agentic_loop.py ----
