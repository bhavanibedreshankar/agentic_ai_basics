...
python3 01_Core_Architecture/tool_use/basic_agentic_tools.py
```
...
- `../../02_Execution_Loops/agentic_loop/basic_agentic_loop.py` — the outer chat loop this template's `main()` follows
- `../../08_Agent_Frameworks_and_Patterns/tool_registry/basic_tool_registry.py` — a scalable alternative to this file's hand-maintained `TOOLS` list + if/elif dispatch
- `../agent/README.md` — this same tool-calling loop shape, repurposed for unattended goal pursuit instead of turn-by-turn chat
- `../../03_Tools_and_Actions/README.md` — server-side and Anthropic-defined client-side tools, building on this custom client-side pattern
