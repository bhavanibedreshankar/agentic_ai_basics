...
(same tool-calling loop shape as ../../Core_Architecture/tool_use/basic_agentic_tools.py),
...
This also contrasts with ../../LangChain/callbacks_and_tracing/callbacks_and_tracing.py
and ../../Safety_and_Control/audit_trail/audit_trail.py: those two are about
...
def run_agent(task: str) -> list[TraceStep]:
    ...
    Same inner-loop shape as ../../Core_Architecture/tool_use/basic_agentic_tools.py's
