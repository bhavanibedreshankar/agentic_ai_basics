...
infrastructure. ../../01_Core_Architecture/token_tracking/basic_token_tracking.py
...
class CacheStats:
    ...
    total-token idea as ../../01_Core_Architecture/token_tracking/basic_token_tracking.py's
