...
full ../../18_LangGraph/ topic directory goes much deeper (state
...
doesn't use a cycle — see ../../18_LangGraph/conditional_routing/ for one —
...
def classify(state: TicketState, llm: BaseChatModel) -> dict:
    ...
    # from being a full chain internally (../../18_LangGraph/ shows that).
    reply = llm.invoke(
