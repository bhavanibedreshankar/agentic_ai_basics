...
This is the SAME core idea as ../../05_Memory/in_context_memory/in_context_memory.py — memory that
lives entirely in a Python process's RAM and vanishes when the process
exits, unlike ../../05_Memory/external_memory/ or ../../05_Memory/episodic_memory/, which persist to
...
../../18_LangGraph/persistence_and_checkpointing/), which persists the full
