...
This template is the LangChain-native version of two existing templates:
  - ../../09_RAG_and_Knowledge/embedding/embedding_search.py hand-rolls a
    dependency-free `embed()` (word-hash buckets) and exposes retrieval as
    a TOOL Claude decides to call mid-conversation.
  - ../../09_RAG_and_Knowledge/rag/basic_rag.py wires retrieval + generation
...
class HashEmbeddings(Embeddings):
    ...
    ../../09_RAG_and_Knowledge/embedding/embedding_search.py's `embed()` docstring for why this
