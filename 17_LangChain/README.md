...
| 7 | [`langgraph_workflows/`](langgraph_workflows/README.md) | A graph of nodes and conditional edges, when a linear pipeline isn't enough (`StateGraph`) — a taste of the full `../18_LangGraph/` topic |
