...
- Contrast with [`../../08_Agent_Frameworks_and_Patterns/prompt_chaining/basic_prompt_chaining.py`](../../08_Agent_Frameworks_and_Patterns/prompt_chaining/README.md), which builds the same kind of fixed-sequence-with-a-gate pipeline by hand, strictly sequentially, with no parallel branch.
...
python3 17_LangChain/chains/chains.py
```
