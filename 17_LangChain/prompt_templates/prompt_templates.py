...
../../01_Core_Architecture/basics/basic.py's `SYSTEM_PROMPT` constant and
../../10_Safety_and_Control/audit_trail/audit_trail.py's inline
...
per call — the same separation ../../08_Agent_Frameworks_and_Patterns/prompt_chaining/basic_prompt_chaining.py
