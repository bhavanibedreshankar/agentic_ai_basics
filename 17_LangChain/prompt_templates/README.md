...
- Contrast with [`../../01_Core_Architecture/basics/basic.py`](../../01_Core_Architecture/basics/README.md) and [`../../10_Safety_and_Control/audit_trail/audit_trail.py`](../../10_Safety_and_Control/audit_trail/README.md), which both build prompts as hand-written f-strings with no validation that every slot got filled.
...
python3 17_LangChain/prompt_templates/prompt_templates.py
```
