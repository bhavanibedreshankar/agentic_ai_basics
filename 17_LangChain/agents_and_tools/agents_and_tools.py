...
../../01_Core_Architecture/tool_use/basic_agentic_tools.py builds this loop by hand: a JSON-Schema
...
LangGraph state graph — see ../../18_LangGraph/ for that layer directly) that
...
# ../../01_Core_Architecture/tool_use/basic_agentic_tools.py — a stand-in for a real database.
