...
../../01_Core_Architecture/tool_use/basic_agentic_tools.py hand-maintains tool metadata in TWO separate places:
...
def register_tool(name: str, description: str, input_schema: dict):
    ...
    function like in ../../01_Core_Architecture/tool_use/basic_agentic_tools.py.
    """
...
# ---------------------------------------------------------------------------
# The agentic loop — identical shape to ../../01_Core_Architecture/tool_use/basic_agentic_tools.py, but tool
