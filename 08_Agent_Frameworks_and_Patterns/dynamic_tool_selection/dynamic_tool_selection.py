...
../../03_Tools_and_Actions/web_search/web_search.py's `web_search`
...
Also contrast with ../../16_Dynamic_Agent_Spawning/dynamic_agent_spawning/:
...
# ../../03_Tools_and_Actions/api_connectors_mcp/).
# ---------------------------------------------------------------------------
