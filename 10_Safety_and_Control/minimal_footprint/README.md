...
python3 10_Safety_and_Control/minimal_footprint/minimal_footprint.py
```
...
- `../../08_Agent_Frameworks_and_Patterns/tool_registry/README.md` — the general tool-registry pattern this template's `TOOL_REGISTRY` builds on, extended with capability tags
