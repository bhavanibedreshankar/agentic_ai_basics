...
in the repo:
  - ../../04_Planning_and_Reasoning/self_reflection/self_reflection.py revises
  ...
  - ../../05_Memory/episodic_memory/episodic_memory.py persists a LOG of past
  ...
  - Here, feedback on an answer is distilled ONCE into a short, reusable
    ...
    grows; ../../01_Core_Architecture/system_prompt/system_prompt.py's prompt,
...
in ../../10_Safety_and_Control/guardrails.py, just applied to the agent's own
