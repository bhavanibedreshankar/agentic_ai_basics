...
| `../04_Planning_and_Reasoning/self_reflection/` | No | One draft, in place | Local variable, gone at exit |
| `../05_Memory/episodic_memory/` | Yes | Nothing — a log the agent can *choose* to consult | `episodes.json` on disk |
