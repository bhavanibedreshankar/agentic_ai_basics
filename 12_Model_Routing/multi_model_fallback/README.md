...
python3 12_Model_Routing/multi_model_fallback/multi_model_fallback.py
```
...
- `MAX_TOKENS`, `EFFORT`, `SYSTEM_PROMPT` — see `../../01_Core_Architecture/basics/README.md`
...
- `../../10_Safety_and_Control/README.md` — other templates about keeping an agent's behavior bounded and predictable under failure
