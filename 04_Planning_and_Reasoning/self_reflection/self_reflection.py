...
Compare this with ../../08_Agent_Frameworks_and_Patterns/prompt_chaining/basic_prompt_chaining.py's
...
contrast with ../../08_Agent_Frameworks_and_Patterns/prompt_chaining/basic_prompt_chaining.py's
...
def critique(task: str, draft: str) -> str:
    ...
    ../../08_Agent_Frameworks_and_Patterns/prompt_chaining/basic_prompt_chaining.py's steps, but this one's
