...
- **`plan_and_execute/`** decides the *shape* of the work up front (a model-generated plan), then works through it step by step — contrast with `../08_Agent_Frameworks_and_Patterns/prompt_chaining/`, where the sequence of steps is fixed by the developer rather than generated per task.
