...
- **`create_manage_memory_tool(namespace, store=...)`** — a tool the model calls itself to create/update/delete a memory, bound on `create_agent` the same way [`../../17_LangChain/agents_and_tools/agents_and_tools.py`](../../17_LangChain/agents_and_tools/README.md) binds its expense tools.
...
python3 19_LangMem/memory_management_tools/memory_management_tools.py
```
...
- [`../../17_LangChain/agents_and_tools/README.md`](../../17_LangChain/agents_and_tools/README.md) — the same `create_agent` + tool-binding pattern, over ordinary business tools instead of memory
