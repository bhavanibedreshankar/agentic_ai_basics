...
`create_agent` exactly the way ../../17_LangChain/agents_and_tools/agents_and_tools.py binds its
...
../../01_Core_Architecture/tool_use/basic_agentic_tools.py's docstring draws for tool use
