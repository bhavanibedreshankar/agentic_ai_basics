...
- Reuses **`HashEmbeddings`** from [`../../17_LangChain/retrieval_augmented_generation/retrieval_augmented_generation.py`](../../17_LangChain/retrieval_augmented_generation/README.md) as the store's embedding function.
- Contrast with [`../../05_Memory/episodic_memory/README.md`](../../05_Memory/episodic_memory/README.md), which hand-rolls a JSON file of episodes and a bag-of-words scoring tool the agent calls itself.
...
python3 19_LangMem/episodic_memory/episodic_memory.py
```
...
- [`../../05_Memory/episodic_memory/README.md`](../../05_Memory/episodic_memory/README.md) — the hand-built version of this exact concept
