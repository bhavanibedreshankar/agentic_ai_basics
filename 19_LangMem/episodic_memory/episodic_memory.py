...
../../05_Memory/episodic_memory/episodic_memory.py builds this by hand: a JSON file of past
...
The store's semantic index reuses ../../17_LangChain/retrieval_augmented_generation/retrieval_augmented_generation.py's
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "..", "17_LangChain", "retrieval_augmented_generation"))
