...
../../05_Memory/semantic_memory/semantic_memory.py builds this exact same idea by hand: a
...
isolation pattern as ../../17_LangChain/memory/memory.py's `session_id`, just for
...
customer/support domain from ../../17_LangChain/prompt_templates/ and
../../17_LangChain/memory/. Type 'exit' to end the session.
"""
