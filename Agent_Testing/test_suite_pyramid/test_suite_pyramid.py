...
(plus the scoring templates in ../../Benchmarking/) by SPEED and COST into
...
The other four templates here are each one LAYER of the pyramid:
  ...
  - a real LLM-as-judge / live-model layer — ../../Benchmarking/
    llm_judge_benchmarking.py and ../../Benchmarking/trace_evaluation/
...
../../Benchmarking/-style scoring templates as the slow tier.
...
# ../../Benchmarking/llm_judge_benchmarking.py's evaluate_output (structured
