...
../../Core_Architecture/tool_use/basic_agentic_tools.py's `run_turn` — the
...
Contrast with ../../Benchmarking/trace_evaluation/trace_evaluation.py: that
...
# and ../../Benchmarking/trace_evaluation/trace_evaluation.py, kept minimal
...
def run_agent(client, task: str) -> list[dict]:
    ...
    ../../Core_Architecture/tool_use/basic_agentic_tools.py's run_turn, plus
