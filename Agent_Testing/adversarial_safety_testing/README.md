...
python3 Agent_Testing/adversarial_safety_testing/adversarial_safety_testing.py
# or
pytest Agent_Testing/adversarial_safety_testing/adversarial_safety_testing.py
```
...
- `../../Safety_and_Control/guardrails/README.md` — the guardrail checks this file's corpus tests are written against
