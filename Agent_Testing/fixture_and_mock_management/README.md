...
python3 Agent_Testing/fixture_and_mock_management/fixture_and_mock_management.py
# or
pytest Agent_Testing/fixture_and_mock_management/fixture_and_mock_management.py
```
