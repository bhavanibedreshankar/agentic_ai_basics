...
python3 07_Multi_Agent_Systems/supervisor_pattern/supervisor_pattern.py
```
...
- `MODEL`, `MAX_TOKENS`, `EFFORT`, `MAX_RETRIES` — see `../../01_Core_Architecture/basics/README.md` for the first three; `MAX_RETRIES` caps retry attempts (default: `3`)
...
- `../../04_Planning_and_Reasoning/self_reflection/README.md` — the model-judged alternative for when criteria are subjective rather than checkable in code
