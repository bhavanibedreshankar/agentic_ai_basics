...
../../04_Planning_and_Reasoning/self_reflection/: that template has ONE
...
def validate_output(raw_output: str) -> tuple[bool, str]:
    ...
    ../../08_Agent_Frameworks_and_Patterns/prompt_chaining/basic_prompt_chaining.py's validate_outline
