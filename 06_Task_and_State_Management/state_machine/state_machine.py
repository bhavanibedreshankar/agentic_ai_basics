...
None of the multi-step templates elsewhere in this repo enforce this. `../../07_Multi_Agent_Systems/agent_handoff/agent_handoff.py`
...
table of which transitions are even legal. `../../04_Planning_and_Reasoning/plan_and_execute/plan_and_execute.py`
