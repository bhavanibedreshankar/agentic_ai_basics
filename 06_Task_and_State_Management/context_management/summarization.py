...
Use case: a general chat agent (like ../../02_Execution_Loops/agentic_loop/basic_agentic_loop.py) that, once
...
def summarize(messages: list[dict]) -> str:
    ...
    chained steps in ../../08_Agent_Frameworks_and_Patterns/prompt_chaining/basic_prompt_chaining.py: one job, its own system
