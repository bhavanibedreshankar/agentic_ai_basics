...
../../01_Core_Architecture/tool_use/basic_agentic_tools.py,
../../13_Benchmarking/trace_evaluation/trace_evaluation.py) writes its tool
...
../../13_Benchmarking/ (which SCORES an agent's live output quality) — this
...
# ---------------------------------------------------------------------------
# The tools under test — same domain as ../../13_Benchmarking/trace_evaluation/
