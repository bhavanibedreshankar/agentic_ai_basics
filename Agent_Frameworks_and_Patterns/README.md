...
| 6 | [`../Planning_and_Reasoning/self_reflection/`](../Planning_and_Reasoning/self_reflection/README.md) | **Reflection Loop** — generate, critique, revise, repeat until quality passes. Stays under `Planning_and_Reasoning/`, where it's already integrated into that topic's own comparison table; linked here rather than duplicated |
