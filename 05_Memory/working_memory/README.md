...
python3 05_Memory/working_memory/working_memory.py
```
...
- `../../04_Planning_and_Reasoning/plan_and_execute/README.md` — the host-managed alternative to this template's model-managed scratchpad
