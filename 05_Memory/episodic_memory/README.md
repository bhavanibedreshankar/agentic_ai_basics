...
python3 05_Memory/episodic_memory/episodic_memory.py
```
...
- `../../06_Task_and_State_Management/context_management/retrieval.py` — the same keyword-overlap technique this template's recall uses, applied there to a fixed knowledge base instead of a growing event log
