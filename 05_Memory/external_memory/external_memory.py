...
this repo, into the pattern a real vector database gives you:
  ...
  - SEMANTIC RETRIEVAL, like ../../09_RAG_and_Knowledge/embedding/ — facts
...
hundreds of them. ../../09_RAG_and_Knowledge/embedding/embedding_search.py's
...
vector database (see ../../09_RAG_and_Knowledge/embedding/README.md for what
...
# ---------------------------------------------------------------------------
# EMBEDDING — same mechanic as ../../09_RAG_and_Knowledge/embedding/embedding_search.py.
...
def save_memory(fact: str) -> str:
    ...
    same principle as ../../09_RAG_and_Knowledge/embedding/'s "build the
