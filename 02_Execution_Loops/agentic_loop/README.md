...
This template's loop is the cycle at its most stripped-down — worth naming explicitly, since every other template in `02_Execution_Loops/` and most of the rest of the repo is a variation on it:
...
python3 02_Execution_Loops/agentic_loop/basic_agentic_loop.py
```
...
- `../../01_Core_Architecture/basics/basic.py` — the single-call building block this loop is built on
