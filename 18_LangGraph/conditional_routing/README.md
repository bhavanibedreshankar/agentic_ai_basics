...
- Contrast with [`../../02_Execution_Loops/max_iterations/README.md`](../../02_Execution_Loops/max_iterations/README.md) (a hand-rolled iteration cap) and [`../../02_Execution_Loops/interrupts_breakpoints/README.md`](../../02_Execution_Loops/interrupts_breakpoints/README.md) (stops early on a condition) — this template's cycle does both at once.
- **`check_draft`** — a plain-code gate with no model call, the same spirit as [`../../08_Agent_Frameworks_and_Patterns/prompt_chaining/README.md`](../../08_Agent_Frameworks_and_Patterns/prompt_chaining/README.md)'s `validate_outline`.
...
python3 18_LangGraph/conditional_routing/conditional_routing.py
```
...
- `MODEL`, `MAX_TOKENS`, `MAX_ATTEMPTS` — see [`../../01_Core_Architecture/basics/README.md`](../../01_Core_Architecture/basics/README.md); `MAX_ATTEMPTS` caps the cycle
...
- [`../../02_Execution_Loops/max_iterations/README.md`](../../02_Execution_Loops/max_iterations/README.md) — the same safety cap, hand-rolled as a `while` loop instead of graph structure
