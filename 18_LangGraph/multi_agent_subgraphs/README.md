...
- Contrast with [`../../07_Multi_Agent_Systems/orchestrator/README.md`](../../07_Multi_Agent_Systems/orchestrator/README.md), where each specialist is a TOOL — one opaque call out and back, with the specialist's internal steps invisible from the orchestrator's side. Here, both specialists' internal nodes are real graph structure, visible in `steps_taken`.
...
python3 18_LangGraph/multi_agent_subgraphs/multi_agent_subgraphs.py
```
...
- [`../../07_Multi_Agent_Systems/orchestrator/README.md`](../../07_Multi_Agent_Systems/orchestrator/README.md) — the same "route to a specialist" idea, with specialists as opaque tool calls instead of subgraphs
