...
../../07_Multi_Agent_Systems/orchestrator/orchestrator.py's orchestrator sees each specialist as a
...
orchestrator's side, and ../../07_Multi_Agent_Systems/worker_agent/ is where you'd go to see
