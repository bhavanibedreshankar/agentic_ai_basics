...
../../17_LangChain/langgraph_workflows/langgraph_workflows.py is a first taste of this from inside the
...
../../05_Memory/working_memory/working_memory.py's scratchpad, where the
