...
Contrast with ../../06_Task_and_State_Management/context_management/retrieval.py: that template scored
...
../../06_Task_and_State_Management/context_management/retrieval.py, but backed by vector search instead
