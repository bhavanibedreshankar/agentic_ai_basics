...
../../06_Task_and_State_Management/context_management/retrieval.py's
...
supports a question a flat-text retrieval tool structurally cannot answer:
  ...
  - trace_call_chain(function_name, direction) — precise: follow ONLY
    ...
    exists in ../../06_Task_and_State_Management/context_management/retrieval.py's
...
def run_turn(messages: list[dict]) -> None:
    """Same inner tool-calling loop as ../../01_Core_Architecture/tool_use/basic_agentic_tools.py."""
    while True:
